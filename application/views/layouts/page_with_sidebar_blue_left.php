...
<html lang="<?php echo $this->data['lang'] ?>">
	...
	<body class="sticky-header-on tablet-sticky-header <?php if(isset($this->data['page-layout'])) { if($this->data['page-layout'] == 'boxed') echo 'boxed-layout'; }?>">
			...
			<header id="header" class="animate-onscroll">
				...
				<div id="lower-header">
					...
					<ul id="navigation">
						...
						<!-- Pages -->
						<li <?php if($this->data['current-menu-item'] == 'Statut' OR $this->data['current-menu-item'] == 'Echipa') echo 'class="current-menu-item"'; ?>>
						
							<span>Despre Noi</span>
							
							<ul>
							
								<li><a href="/despre/statut">Statut</a></li>
								<li><a href="/despre/echipa">Echipa</a></li>
								<li><a href="/program/politic">Program Politic</a></li>
								<li><a href="/program/electoral">Program Electoral</a></li>
						...
						<!-- Get Involved -->
						<li <?php if($this->data['current-menu-item'] == 'Cotizatii') echo 'class="current-menu-item"'; ?>>
							<a href="cotizatii">Cotizații</a>
						</li>
						<!-- /Get Involved -->
						...
						<li <?php if($this->data['current-menu-item'] == 'Organizații Locale') echo 'class="current-menu-item"'; ?>>
							...
							<a href="/organizatii">Organizații Locale</a>
						
						</li>
						<!-- /Shop -->

						<!-- Blog -->
						<li <?php if($this->data['current-menu-item'] == 'Contact') echo 'class="current-menu-item"'; ?>>
						
							<a href="/contact"><?php echo $this->lang->line('contact_us') ?></a>
		...
		<section id="content">
			<?php $this->load->view($view, !empty($data) ? $data : array()); ?>
		</section>
